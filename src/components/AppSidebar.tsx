import { Home, FileText, DollarSign, Users, Calendar, Image, Table2, Building, LogOut, Receipt, Settings, Crown, Stethoscope, User, Truck, Bike, MessageSquare, Bot, FileCheck, Webhook, BadgeCheck } from "lucide-react";
...
const menuItems = [
  ...
  { title: "Fiscal", url: "/fiscal", icon: FileCheck },
  { title: "Planos", url: "/planos", icon: Crown },
  { title: "Minha Assinatura", url: "/minha-assinatura", icon: BadgeCheck },
  { title: "Diagnóstico MP", url: "/mercadopago-diagnostico", icon: Webhook },
